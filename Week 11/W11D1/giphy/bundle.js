...
var GiphysIndex = function GiphysIndex(props) {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", null, props.giphys.map(function (giphy) {
...
var GiphysIndexItem = function GiphysIndexItem(props) {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("img", {
    src: props.giphy.images.fixed_height.url
  }));
};
...
var fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  return $.ajax({
    method: "GET",
    url: "http://api.giphy.com/v1/gifs/search?q=".concat(searchTerm, "&api_key=0K8R7UEOH3fhDbch7HUh0m1hUcm6muZy&limit=2")
  });
};
